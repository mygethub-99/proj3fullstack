...
restaurant1 = Restaurant(user_id=1, name="Urban Burger", address="1321 Commerce St, The Adolphus Hotel, Dallas, TX 75202", phone="989-234-6070", cuisine_cat="American", health_rating= "Poor", picture ='/static/urbanburger.png')
...
restaurant2 = Restaurant(user_id=1, name="Super Stir Fry", address="5500 Greenville Ave, Dallas, TX 75206", phone="989-245-6071", cuisine_cat="Asian", health_rating= "Poor", picture= '/static/chinese.jpg')
...
restaurant1 = Restaurant(user_id=1, name="Panda Garden",address="3511 Oak Lawn Ave, Dallas, TX 75219", phone="989-865-7530", cuisine_cat="Asian", health_rating= "Good", picture= '/static/stirfry.jpg')
...
restaurant1 = Restaurant(user_id=1, name="Thyme for That Vegetarian Cuisine", address="4901 Bryan St, Dallas, TX 75206-7613", phone="128-234-5550", cuisine_cat="Vegetarian", health_rating= "Excellent", picture= '/static/veg.jpg')
...
restaurant1 = Restaurant(user_id=1, name="Tony's Bistro", address="1322 Commerce St, The Adolphus Hotel, Dallas, TX 75202", phone="946-430-6070", cuisine_cat="Italian", health_rating= "Excellent", picture= '/static/tonysbistro.png')
...
# Menu for Andala's
restaurant1 = Restaurant(user_id=1, name="Andala's", address="10477 Lombardy Ln, Dallas, TX 75220-4349", phone="989-234-6070", cuisine_cat="Italian", health_rating= "Good", picture= '/static/andala.png')
...
restaurant1 = Restaurant(user_id=1, name="Auntie Ann\'s Diner' ", address="8300 Preston Road, Dallas, TX 75225", phone="989-504-6045", cuisine_cat="American", health_rating= "Fair", picture = '/static/auntannies.jpg')
...
restaurant1 = Restaurant(user_id=1, name="Cocina Y Amor ", address="2401 McKinney Ave, Dallas, TX 75201", phone="981-232-6570", cuisine_cat="Mexican", health_rating= "Poor", picture= '/static/Mexican.png')
...
restaurant1 = Restaurant(user_id=1, name="Stratos", address="2907 W Northwest Hwy, Dallas, TX", phone="857-234-1270", cuisine_cat="Greek", health_rating= "Good", picture = '/static/stratos.png')
session.add(restaurant1)
session.commit()
